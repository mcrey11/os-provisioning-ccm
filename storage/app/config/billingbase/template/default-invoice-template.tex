...
\makeatletter
	% See koma script tutorial page 397 - 402
...
\begin{document}
	...
	\begin{letter}{{contract\_address}}
		...
		\ifthenelse{\equal{{modem\_address}}{}}
		{} {
			\begin{flushleft}
				Folgende Rechnung bezieht sich auf den Anschlussstandort:\\
				\vspace{1.5mm}
				{modem\_salutation} {modem\_address}
			\end{flushleft}
		}
		...
		% §13 tax exemption info
		\ifthenelse{\equal{{p13\_tax\_exempted}}{true}}
		{
			\begin{flushleft}
