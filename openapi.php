...
$ignore = [
    ...
    'contact_point.street',
    'contact_point.house_number',
    'contact_point.additional',
    'contact_point.zip',
    'contact_point.city',
    'contract.contact_point_id',
    'crm_lead.type',
    'crm_lead.salutation',
    'crm_lead.firstname',
    'crm_lead.lastname',
    ...
    'crm_lead.birthday',
    'crm_lead.street',
    'crm_lead.house_number',
    'crm_lead.additional',
    'crm_lead.zip',
    'crm_lead.city',
    'crm_opportunity.type',
    'crm_opportunity.salutation',
    'crm_opportunity.firstname',
    'crm_opportunity.lastname',
    'crm_opportunity.company',
    'crm_opportunity.email',
    'crm_opportunity.phone',
    'crm_opportunity.birthday',
    'crm_opportunity.street',
    'crm_opportunity.house_number',
    'crm_opportunity.additional',
    'crm_opportunity.zip',
    'crm_opportunity.city',
    'crm_opportunity.notes',
    'debt.total_fee',
    'global_config.logo_admin_upload',
    'product.logo_upload',
    'product_region_rule.scope_ref_city',
    'product_region_rule.scope_ref_street',
    'product_region_rule.scope_ref_realty',
    'product_region_rule.scope_ref_apartment',
    'tax.costcenters_ids[]',
    'ticket_type_transition.assignees_ids[]',
    'web_order_item.web_order_id',
    'web_order_item.type',
    'web_order_item.product_id',
    'web_order_item.name',
    'web_order_item.sort',
    'web_order_item.custom_data_for_form',
];
