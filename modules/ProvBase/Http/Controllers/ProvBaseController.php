...
class ProvBaseController extends BaseController
{
    ...
    public function view_form_fields($model = null)
    {
        ...
        return [
            ...
            ['form_type' => 'text', 'name' => 'dns_password', 'description' => 'DNS update password', 'help' => 'MD5 HMAC; create using: ddns-confgen -a hmac-md5 | grep secret', 'hidden' => \Module::collections()->has('ProvHA')],
            ...
            ['form_type' => 'text', 'name' => 'max_cpe', 'description' => 'Max CPEs per Modem', 'help' => trans('helper.max_cpe')],
            ...
            ['form_type' => 'checkbox', 'name' => 'sync_provision', 'description' => trans('messages.syncProvision'), 'help' => trans('helper.syncProvision')],
