...
class Modem extends \BaseModel
{
    ...
    public function rules()
    {
        ...
        $rules = [
            'mac' => ['mac', "iunique:modem,mac,{$id},id,deleted_at,NULL"],
    ...
    private function getCmDhcpEntryHostLine()
    {
        ...
        return 'host '.$hostname.' { hardware ethernet '.$this->mac.'; filename "cm/'.$hostname.'.cfg"; ddns-hostname "'.$hostname.'";';
    }
    ...
    public function radiusData()
    {
        ...
        $sessionItems = [
            ...
            ['framedipaddress', 'IPv4', null],
            ['framedipv6address', 'IPv6', null],
        ];
