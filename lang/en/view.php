...
return [
    ...
    'ccc' => [
        ...
        'password_reset' => [
            ...
            'modal_help' => 'Enter the email address stored for your customer account. You will receive a link to choose a new password.',
            'email_label' => 'Email',
            'modal_cancel' => 'Cancel',
            'modal_submit' => 'Send email',
            'dialog_title' => 'Choose a new password',
            'new_password' => 'New password',
            'new_password_confirm' => 'Confirm new password',
            'submit' => 'Save password',
            'page_title' => 'Reset password',
            'email_intro' => 'You requested a password reset for the customer portal. Click the button below to set a new password. This link expires soon.',
            'email_button' => 'Reset password',
            'email_outro' => 'If you did not request a reset, you can ignore this message.',
            'email_salutation' => 'Kind regards',
            'email_subject' => 'Customer portal password reset',
        ],
    ],
