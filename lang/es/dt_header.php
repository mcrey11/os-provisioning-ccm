...
return [
    ...
    'contact_point_id' => 'Punto de contacto',
    'realty_id' => 'Propiedad',
    ...
    'web_order' => [
        'contact_point_id' => 'Punto de Contacto',
        'service_address_id' => 'Dirección de Servicio',
        'billing_address_id' => 'Dirección de Facturación',
        'crm_opportunity_id' => 'Oportunidad CRM',
        'apartment_id' => 'Apartamento',
        'realty_id' => 'Inmueble',
        'customer_type' => 'Tipo de Cliente',
        'is_switcher' => 'Cambiador',
        'state' => 'Estado',
        'payment_method' => 'Método de Pago',
        'payment_status' => 'Estado del Pago',
        'payment_reference' => 'Referencia de Pago',
        'payment_data' => 'Datos de Pago',
        'porting_data' => 'Datos de Portabilidad',
        'hash' => 'Hash',
        'order_number' => 'Número de Pedido',
        'availability_snapshot' => 'Instantánea de Disponibilidad',
        'utm_json' => 'Datos UTM',
        'consent_json' => 'Datos de Consentimiento',
        'notes' => 'Notas',
        'created_at' => 'Creado En',
        'updated_at' => 'Actualizado En',
    ],
    'web_order_item' => [
        'headline' => 'Artículo de Pedido Web',
        'web_order_id' => 'Pedido Web',
    ...
    'web_order_items_conversion' => [
        'headline' => 'Solicitud de Actualización de Producto',
    ],
    'product_region_rule' => [
        'type' => 'Tipo',
        'product_id' => 'Producto',
        'product_layer_id' => 'Capa de Producto',
        'rule' => 'Regla',
    ],
];
