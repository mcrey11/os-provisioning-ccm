...
return new class extends BaseMigration
{
    ...
    public function up()
    {
        // Add 'zyxelont' value to the existing configfile_device enum type
        DB::statement("ALTER TYPE nmsprime.configfile_device ADD VALUE 'zyxelont'");
    }
    ...
    public function down()
    {
        ...
        // 1. Create a new enum type without 'zyxelont'
        ...
        $this->warn('Cannot automatically remove enum value "zyxelont" from configfile_device type.');
